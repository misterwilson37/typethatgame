...
.letter {
    ...
    line-height: 2.0em; padding: 0 1px; position: relative; color: #ccc; border-radius: 3px;
}

.letter.space { min-width: 14.4px; border-bottom: none !important; text-decoration: none !important; }

.letter.tab {
    width: 50px; text-align: center; border-bottom: 1px dotted #ddd; color: transparent; 
}
.letter.tab::before {
...
#virtual-keyboard {
    height: 260px; background: var(--accent-grey);
...
#modal {
    ...
    box-sizing: border-box;
    height: 284px; /* matches keyboard total height */
    padding: 12px 30px;
...
#modal-body { flex: 1; display: flex; flex-direction: column; justify-content: center; text-align: center; overflow: hidden; min-height: 0; }
...
.stats-inline { display: flex; justify-content: center; align-items: baseline; gap: 10px; margin: 10px 0; font-size: 1.6em; font-weight: bold; }
.si-val small { font-size: 0.6em; font-weight: normal; color: #777; }
.si-dot { color: #ccc; font-weight: normal; }

.cumulative-row { display: flex; justify-content: center; gap: 30px; font-size: 0.95em; color: #666; margin: 6px 0; }
...
.hg-finger-group .hg-home {
    fill: var(--guide-color, #4FC3F7); fill-opacity: 0.4;
    stroke: var(--guide-color, #4FC3F7); stroke-width: 1.5; stroke-opacity: 0.35;
}
.hg-finger-group .hg-body {
    stroke: var(--guide-color, #4FC3F7); stroke-opacity: 0;
}
.hg-finger-group .hg-tip {
    fill: var(--guide-color, #4FC3F7); fill-opacity: 0;
    stroke: var(--guide-color, #4FC3F7); stroke-width: 0; stroke-opacity: 0;
}

/* Active: finger reaching to target */
.hg-finger-group.hg-active .hg-home {
    fill-opacity: 0.55; stroke-opacity: 0.6;
}
.hg-finger-group.hg-active .hg-body {
    stroke-opacity: 0.4;
}
.hg-finger-group.hg-active .hg-tip {
    fill-opacity: 0.8; stroke-width: 2; stroke-opacity: 0.9;
    filter: drop-shadow(0 0 5px var(--guide-color, #4FC3F7));
}

/* Shift pinky reaching */
.hg-finger-group.hg-shift-active .hg-home { fill-opacity: 0.45; stroke-opacity: 0.5; }
.hg-finger-group.hg-shift-active .hg-body { stroke-opacity: 0.25; }
.hg-finger-group.hg-shift-active .hg-tip { fill-opacity: 0.55; stroke-width: 1.5; stroke-opacity: 0.6; }
